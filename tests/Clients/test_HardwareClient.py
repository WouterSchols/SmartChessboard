...
class TestHardwareClient(TestCase):
    ...
    def setUp(self):
        ...
        self.hwi_mock = mock.Mock()
        self.hc._hwi = self.hwi_mock
    ...
    def test__hw_control_case_1(self):
        """ Test _hw_control player move"""
        self.hc._board.turn = chess.WHITE
        self.hc.color = chess.WHITE
        with patch.object(HardwareClient.HardwareClient, 'game_is_over') as game_over_mock:
    ...
    def test__hw_control_case_2(self):
    ...
    def test__hw_detect_move_player_normal(self):
        """ Test detect normal move """
        # Configure occupancy
        set_occupancy(self.hwi_mock, self.hc._board)
        self.hwi_mock.get_occupancy.return_value[0][1] = False
        self.hwi_mock.get_occupancy.return_value[0][3] = True
        ...
        self.assertEqual(self.hc._output_playResult.move.from_square, chess.square(0, 1),
                         "Detected from square was not a2")
        self.assertEqual(self.hc._output_playResult.move.to_square, chess.square(0, 3), "Detected to square was not a4")
    ...
    def test__hw_detect_move_player_capture(self):
        ...
        self.assertIsNotNone(self.hc._output_playResult, "Output move has not been processed")
        self.assertEqual(self.hc._output_playResult.move.from_square, chess.square(1, 3),
                         "Detected from square was not b4")
        self.assertEqual(self.hc._output_playResult.move.to_square, chess.square(0, 4),
                         "Detected to square was not a5")
    ...
    def test__hw_detect_move_player_promote(self):
        ...
        self.assertIsNotNone(self.hc._output_playResult, "Output move has not been processed")
        self.assertEqual(self.hc._output_playResult.move.from_square, chess.square(0, 6),
                         "Detected from square was not b7")
        self.assertEqual(self.hc._output_playResult.move.to_square, chess.square(0, 7),
                         "Detected to square was not a8")
        self.assertEqual(self.hc._output_playResult.move.promotion, chess.QUEEN,
                         "Detected promotion piece move was not a queen")

    def test__hw_detect_move_player_reject_opponent(self):
        """ Test that opponent moves are rejected """
        # Configure occupancy
        set_occupancy(self.hwi_mock, self.hc._board)
        self.hwi_mock.get_occupancy.return_value[0][6] = False
        self.hwi_mock.get_occupancy.return_value[0][4] = True
    ...
    def test__hw_detect_move_player_reject_incomplete(self):
    ...
    def test__hw_detect_move_player_reject_illegal(self):
    ...
    def test__hw_detect_move_player_reject_corrupted(self):
    ...
    def test__hw_play_move_opponent_move_normal(self):
        ...
        marking1[0][1] = True
        marking1[0][3] = True
        self.hwi_mock.mark_squares.assert_has_calls([call(marking1), call(marking2)],
    ...
    def test__diff_occupancy_board_same(self):
        """ Assert _diff_occupancy_board does not detect a diff if occupancy has expected value """
        set_occupancy(self.hwi_mock, self.hc._board)
        diff = self.hc._diff_occupancy_board(self.hwi_mock.get_occupancy.return_value)
    ...
    def test_game_is_over(self):
        ...
        self.hc._board = board_mock
        board_mock.is_checkmate.return_value = False
        self.assertFalse(self.hc.game_is_over(), "Incorrectly detected game over")

        self.hc._stop_flag = True
        self.assertTrue(self.hc.game_is_over(), "Setting stop flag ignored")

        self.hc._stop_flag = False
        self.hc._input_playResult = chess.engine.PlayResult(None, None, resigned=True)
        self.assertTrue(self.hc.game_is_over(), "Resign ignored")

        self.hc._input_playResult = None
        board_mock.is_checkmate.return_value = True
        self.assertTrue(self.hc.game_is_over(), "Checkmate ignored")
